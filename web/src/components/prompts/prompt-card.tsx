        ...
        <Card
            ...
            cover={
                <button type="button" className="block w-full text-left" onClick={onOpen}>
                    {cover ? <img src={cover} alt={item.title} className="aspect-[4/3] w-full object-cover" loading="lazy" /> : <span className="grid aspect-[4/3] w-full place-items-center bg-stone-100 text-stone-400 dark:bg-stone-900 dark:text-stone-600"><FileText className="size-8" /></span>}
                </button>
            }
        >
            <button type="button" className="block w-full text-left" onClick={onOpen}>
