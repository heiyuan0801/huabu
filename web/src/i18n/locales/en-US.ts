export default {
    meta: {
        title: "Future Canvas",
        description: "A future-facing canvas creation tool",
    },
    siteNotice: {
        title: "Future Canvas Community",
        description: "Welcome to Future Canvas. Visit Weilai Relay for model-channel and service information, or join the QQ group for support and creative discussion.",
        footer: "Weilai Relay · QQ Group {{group}}",
        qqLabel: "QQ group",
        copyGroup: "Copy group number",
        copied: "Group number copied",
        visitRelay: "Visit Weilai Relay",
    },
    ...
    settingsPanels: {
        ...
        video: { title: "Video settings", quality: "Quality", size: "Size", seconds: "Seconds", resolution: "Resolution", ratio: "Aspect ratio", duration: "Duration", mode: "Mode", generate: "Generate video", edit: "Edit video", extend: "Extend video", smart: "Smart", output: "Output", generateAudio: "Generate audio", watermark: "Add watermark", adaptive: "Adaptive", sizes: { landscape: "Landscape", portrait: "Portrait", square: "Square", widescreen: "Widescreen", tall: "Tall", auto: "Auto" }, ratios: { landscape: "Landscape", portrait: "Portrait", square: "Square", standardLandscape: "Standard landscape", standardPortrait: "Standard portrait", cinematic: "Cinematic", adaptive: "Adaptive" } },
    ...
    imageWorkbench: {
        ...
        logSaveFailed: "Images were generated, but the generation log could not be saved",
    ...
    imageChat: {
        ...
        recent: "Recent",
        untitled: "New chat",
        noHistory: "No matching chats",
        emptyTitle: "What will you create today?",
        emptySubtitle: "An idea can begin with a single sentence",
        placeholder: "Describe the image you want to create",
        skillPlaceholder: "Optional: add relationships, text language, or an emotional direction to preserve",
        skill: "Image Skill",
        skills: {
            none: "Standard generation",
            "scenes-gathered-zine": "Gathered-scenes zine",
            "scene-distillation-zine": "Scene-distillation zine",
        },
        referenceImage: "Reference image",
        uploadReference: "Upload an image and generate with a Skill",
        replaceReference: "Replace reference image",
        removeReference: "Remove reference image",
        referenceRequired: "Upload one reference image first",
        send: "Send",
        stop: "Stop generation",
        configRequired: "Configure an available image model first",
        missingResult: "The API returned no image",
        historySaveFailed: "The image was generated, but its generation record could not be saved",
        ...
        duration: "Took {{time}}",
        retry: "Retry",
        polishAndGenerate: "Polish and generate",
        polishDescription: "Polish the prompt with {{model}}, then generate the image",
        textConfigRequired: "Configure an available text model first",
        polishFailed: "Prompt polishing failed",
        polishEmpty: "The text model returned no polished prompt",
        polishInstruction: "You are a professional image-generation prompt editor. Preserve the user's intent and rewrite the input as a specific, clear prompt ready for an image model. Add useful details about the subject, scene, composition, lighting, materials, color, and style. Return only the polished prompt, with no explanation, heading, or quotation marks.",
    ...
    ecommerce: {
        ...
        subtitle: "Turn a product image into a coordinated detail-page sequence and vertical long image",
        untitledProduct: "Product",
        productImage: "Product image",
        uploadProduct: "Upload a clear product image",
        removeProduct: "Remove product image",
        productInfo: "Product details and selling points",
        productInfoPlaceholder: "For example: a portable coffee maker with a matte black body, 15-bar pressure, 30-second extraction, designed for offices and camping, targeting efficiency-minded young professionals.",
        creativeStrategy: "Creative strategy",
        packageType: "Image package",
        packageTypes: {
            detail: "PDP long page",
            listing: "Marketplace listing set",
            amazonAplus: "Amazon A+",
        },
        conversionDriver: "Conversion driver",
        conversionDrivers: {
            visual: "Visual desirability",
            pain: "Pain-point solution",
            emotional: "Emotional scenario",
        },
        visualPreset: "Visual direction",
        visualPresets: {
            clean: "Clean commercial",
            lifestyle: "Natural lifestyle",
            luxury: "Restrained luxury",
            ugc: "Credible social",
        },
        sceneTemplate: "Scene template",
        sceneVariant: "Style variant",
        templateModes: {
            auto: "Smart match",
            manual: "Manual",
        },
        templateGroups: {
            ...
            information: "Features and information",
            people: "People and experience",
            technical: "Structure and presentation",
            campaign: "Brand campaigns",
        },
        variantAuto: "Choose variant automatically",
        templateAutoDescription: "Match a template and variant from all 25 scenes for each section using the product request, package target, and section role.",
        antiAiTreatment: "Authentic anti-AI texture",
        marketMode: "Sales market",
        marketModes: {
            domestic: "China domestic",
            crossBorder: "Cross-border",
        },
        crossBorderStrategy: "Cross-border market strategy",
        complianceReview: "Platform compliance review",
        ...
        audienceProfile: "Target buyer and purchase context",
        audienceProfilePlaceholder: "For example: urban US commuters and fitness buyers who value portable nutrition, leak resistance, and quick cleaning.",
        offerDetails: "Offer and CTA assets",
        offerDetailsPlaceholder: "Enter verified price, discount, bundle, shipping, warranty, bonus, or CTA details. No offer is invented when empty.",
        templateAutoInstruction: "For every section, select the best templateId from the 25-template catalog below and choose a variantId listed for that template. Different sections may use different templates. Catalog:\n{{catalog}}",
        templateManualInstruction: "Use template {{templateId}} ({{templateName}}) for every section. Fix or prioritize this variant: {{variant}}. Return the same templateId and corresponding variantId in every item.",
        styleLock: "Brand style lock (optional)",
        styleLockPlaceholder: "For example: brand red #E53935, warm-white backgrounds, soft light from the right, rounded line icons, and generous spacing. Every section will reuse this lock.",
        proofPoints: "Verified proof (optional)",
        proofPointsPlaceholder: "Enter real dimensions, materials, tests, warranties, reviews, or comparison data that may appear. No certification or quantified claim is created when this is empty.",
        autoStyleLock: "Derive a restrained palette and material language from the reference product",
        noProofPoints: "No verified proof supplied; do not create certifications, test results, ratings, warranties, dimensions, or quantified outcomes",
        sectionCount: "Sections",
        ratio: "Image ratio",
        changeRatioTitle: "Change image ratio",
        changeRatioConfirm: "Changing the ratio will clear the current sections and long image. Continue?",
        imageModel: "Image model",
        planningModel: "Planning model",
        copyOverlay: "Independent copy layer",
        platformPreset: "Platform export preset",
        sliceHeight: "Slice height",
        presets: {
            taobao: "Taobao / Tmall · {{width}}px",
            jd: "JD · {{width}}px",
            pdd: "Pinduoduo · {{width}}px",
            douyin: "Douyin Commerce · {{width}}px",
            hd: "High-resolution · {{width}}px",
        },
        generate: "Generate product detail page",
        generating: "Generating · {{time}}",
        phases: {
            planning: "Planning sections · {{time}}",
            generating: "Generating images · {{time}}",
            editing: "Editing image · {{time}}",
            composing: "Composing long image",
            exporting: "Exporting slices",
        },
        detailPreview: "Detail-page sections",
        compose: "Compose long image",
        composing: "Composing long image",
        moveUp: "Move earlier",
        moveDown: "Move later",
        deleteSectionTitle: "Delete section",
        deleteSectionConfirm: "Delete “{{title}}” and recompose the long image?",
        previousVersion: "Previous version",
        nextVersion: "Next version",
        editSection: "Edit image",
        editSectionTitle: "Edit and regenerate section",
        regenerateSection: "Regenerate and compose",
        editPromptPlaceholder: "Describe what to preserve and change, for example: keep the product and composition, replace the background with an outdoor camping scene, and use brighter lighting.",
        editPromptRequired: "Enter the requested changes",
        localizing: "Saving locally in the background without blocking your work",
        localizeRetry: "Local save failed. Click to retry.",
        editCopy: "Edit independent copy",
        editCopyTitle: "Edit section copy",
        overlayTitle: "Headline",
        overlayBody: "Supporting copy",
        longImage: "Detail-page long image",
        longImageCount: "{{count}} sections included",
        longImageEmpty: "Generated sections will be composed vertically in order",
        exportSlices: "Download sliced package",
        slicedPackage: "detail-page-slices",
        exportedSlices: "Exported {{count}} image slices",
        exportFailed: "Slice export failed. Recompose the long image and try again.",
        emptyTitle: "Ready to create a product detail page",
        emptyDescription: "Upload a product image and enter verified selling points. The planner will define the sections before generating a consistent image set.",
        waiting: "Waiting",
        referenceRequired: "Upload a product image first",
        referenceReadFailed: "The product image could not be read. Upload it again.",
        productInfoRequired: "Enter the product details and core selling points",
        planInvalid: "The planning model returned an invalid section format. Try again.",
        planFallback: "The planning service is temporarily unavailable. Continuing with a local standard storyboard.",
        composeFailed: "The long image could not be composed. Some remote images may block cross-origin access.",
        generationFailed: "Product detail-page generation failed",
        generatedSummary: "Detail page completed: {{success}}/{{total}} images generated",
        assetTag: "E-commerce detail",
        fallbackStages: {
            hero: "Brand hero",
            benefit: "Core benefit",
            benefitExtra: "Supporting benefit",
            material: "Materials and structure",
            detail: "Detail close-up",
            scene: "Use case",
            trust: "Specifications and trust",
            closing: "Closing atmosphere",
        },
        sceneRoles: {
            hero: "Product hero",
            ...
            trust: "Trust and close",
        },
        fallbackPrompt: "Create a {{packageType}} section focused on {{focus}}, using {{conversionDriver}} as the conversion driver. Center the product and one clear information goal, with an intentional safe area for the independent copy layer.",
        domesticPlanInstruction: "You are a senior mainland China e-commerce visual director. Use the product reference and verified user information to plan {{count}} images at {{ratio}} for {{domesticPlatform}}. Package target: {{packageType}}; sequence principle: {{packageHint}}; conversion driver: {{conversionDriver}}; conversion principle: {{conversionHint}}; visual direction: {{visualPreset}}; brand rules: {{styleNotes}}; verified proof: {{proofPoints}}. Do not apply Amazon, overseas-market, foreign-currency, foreign-unit, or foreign-language copy rules. Template rule: {{templateInstruction}}. Available scene roles follow; every section must select one role:\n{{roleLibrary}}\nReturn only one JSON array with exactly {{count}} items. Each item must be {\"title\":\"short Simplified Chinese internal section name\",\"role\":\"role code\",\"templateId\":\"scene template code\",\"variantId\":\"variant code or an empty string\",\"headline\":\"concise natural Simplified Chinese independent-copy headline\",\"body\":\"concise natural Simplified Chinese independent-copy body, possibly empty\",\"prompt\":\"section-specific composition, setting, lighting, camera, and information-layout direction\"}. Keep headline/body copy short and suitable for mobile domestic-commerce layouts. Give every section a distinct conversion job and vary camera distance and composition rhythm while preserving product shape, logo, color, material, and proportions. Use only verified product information and proof; never invent specifications, certification, reviews, price, discount, shipping, warranty, outcomes, or competitors. Do not repeat the scene template, Campaign Style Lock, full product information, or instructions to render text inside prompt; the application adds those consistently. Images default to no rendered text and reserve space for the independent copy layer. Do not return Markdown, explanations, or text outside the JSON array.",
        planInstruction: "You are a senior cross-border e-commerce visual director. Use the product reference and verified user information to plan {{count}} images at {{ratio}}. Package target: {{packageType}}; sequence principle: {{packageHint}}; conversion driver: {{conversionDriver}}; conversion principle: {{conversionHint}}; visual direction: {{visualPreset}}; brand rules: {{styleNotes}}; verified proof: {{proofPoints}}. Cross-border market lock: {{marketBrief}}. Template rule: {{templateInstruction}}. Available scene roles follow; every section must select one role:\n{{roleLibrary}}\nReturn only one JSON array with exactly {{count}} items. Each item must be {\"title\":\"short internal section name\",\"role\":\"role code\",\"templateId\":\"scene template code\",\"variantId\":\"variant code or an empty string\",\"headline\":\"independent-copy headline following the COPY LOCALE rule\",\"body\":\"independent-copy body following the COPY LOCALE rule, possibly empty\",\"prompt\":\"section-specific composition, setting, lighting, camera, and information-layout direction\"}. All headline/body copy must sound native in the target market, avoid literal translation, and stay mobile-short. Give every section a distinct conversion job and vary camera distance and composition rhythm while preserving product shape, logo, color, material, and proportions. Use only verified proof and offer assets; never invent specifications, certification, reviews, price, discount, shipping, warranty, outcomes, or competitors. Do not repeat the scene template, Campaign Style Lock, CROSS-BORDER MARKET LOCK, full product information, or instructions to render text inside prompt; the application adds those consistently. Images default to no rendered text and reserve space for the independent copy layer. Do not return Markdown, explanations, or text outside the JSON array.",
    },
    videoWorkbench: {
        title: "Video Studio",
    ...
    canvas: {
        defaultTitle: "Future Canvas {{count}}",
        ...
        export: { defaultProjectName: "Future Canvas", defaultNodesName: "Canvas elements", item: "Element" },
        createMenu: {
    ...
    home: {
        ...
        description: "Generate, connect, and reshape <content>images, text, and graphics</content> in <canvas>Future Canvas</canvas>, turning one-off generations into a continuous creative process.",
        start: "Get started",
    ...
    config: {
        ...
        localStorage: {
            ...
            description: "View browser data saved by Future Canvas, grouped by object store.",
            ...
            mainDatabase: "Future Canvas data",
