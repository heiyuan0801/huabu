export default {
    meta: {
        title: "未来画布",
        description: "一个面向未来的画布创作工具",
    },
    siteNotice: {
        title: "未来画布社区",
        description: "欢迎使用未来画布。模型渠道与服务信息可前往未来中转站查看，也可以加入 QQ 交流群获取使用帮助和交流创作经验。",
        footer: "未来中转站 · QQ 交流群 {{group}}",
        qqLabel: "QQ 交流群",
        copyGroup: "复制群号",
        copied: "群号已复制",
        visitRelay: "访问未来中转站",
    ...
    settingsPanels: {
        ...
        video: { title: "视频设置", quality: "清晰度", size: "尺寸", seconds: "秒数", resolution: "分辨率", ratio: "比例", duration: "时长", mode: "类型", generate: "视频生成", edit: "视频剪辑", extend: "视频扩展", smart: "智能", output: "输出", generateAudio: "生成声音", watermark: "添加水印", adaptive: "自适应", sizes: { landscape: "横屏", portrait: "竖屏", square: "方形", widescreen: "宽屏", tall: "长图", auto: "自动" }, ratios: { landscape: "横屏", portrait: "竖屏", square: "方形", standardLandscape: "标准横屏", standardPortrait: "标准竖屏", cinematic: "宽银幕", adaptive: "自适应" } },
    ...
    imageChat: {
        ...
        noHistory: "没有匹配的对话",
        emptyTitle: "今天想创造什么？",
        emptySubtitle: "灵感可以从一句话开始",
        placeholder: "描述你想生成的画面",
        skillPlaceholder: "可选：补充希望保留的关系、文字语言或情绪方向",
        skill: "生图 Skill",
        skills: {
            none: "普通生图",
            "scenes-gathered-zine": "实景拼贴志",
            "scene-distillation-zine": "影像蒸馏志",
        },
        referenceImage: "参考图片",
        uploadReference: "上传图片并使用 Skill 生图",
        replaceReference: "更换参考图片",
        removeReference: "移除参考图片",
        referenceRequired: "请先上传一张参考图片",
        send: "发送",
        stop: "停止生成",
        configRequired: "请先配置可用的图片模型",
        missingResult: "接口没有返回图片",
        historySaveFailed: "图片已生成，但生成记录保存失败",
        ...
        duration: "耗时 {{time}}",
        retry: "重试",
        polishAndGenerate: "润色并生成",
        polishDescription: "使用 {{model}} 润色提示词后自动生成图片",
        textConfigRequired: "请先配置可用的文本模型",
        polishFailed: "提示词润色失败",
        polishEmpty: "文本模型没有返回润色后的提示词",
        polishInstruction: "你是专业的图片生成提示词编辑器。请保留用户原意，将输入润色为具体、清晰、可直接提交给图片生成模型的提示词，补充主体、场景、构图、光线、材质、色彩与风格细节。只输出润色后的提示词，不解释，不加标题或引号。",
        interrupted: "生成已中断",
        generatedImage: "生成图片",
        deleteTitle: "删除对话",
    ...
    ecommerce: {
        title: "电商生图",
        subtitle: "用商品主图生成成套详情页分镜与竖向长图",
        untitledProduct: "商品",
        productImage: "商品主图",
        uploadProduct: "上传清晰的商品主图",
        removeProduct: "移除商品主图",
        productInfo: "商品信息与卖点",
        productInfoPlaceholder: "例如：便携咖啡机，磨砂黑机身，15Bar 压力，30 秒快速萃取，适合办公室与露营。目标用户为注重效率的年轻白领。",
        creativeStrategy: "创作策略",
        packageType: "图包目标",
        packageTypes: {
            detail: "详情页长图",
            listing: "平台主图组",
        ...
        variantAuto: "自动选择变体",
        templateAutoDescription: "根据商品描述、图包目标和每张分镜职责，从 25 个场景中自动匹配模板与变体。",
        antiAiTreatment: "反 AI 真实质感",
        marketMode: "销售市场",
        marketModes: {
            domestic: "国内电商",
            crossBorder: "跨境电商",
        },
        crossBorderStrategy: "跨境市场策略",
        complianceReview: "平台合规审查",
        targetChannel: "目标渠道",
        channels: {
            amazon: "Amazon",
            shopify: "Shopify",
        ...
        audienceProfile: "目标买家与购买场景",
        audienceProfilePlaceholder: "例如：美国城市通勤与健身人群，希望快速补充营养，重视便携、防漏和清洗效率。",
        offerDetails: "Offer 与 CTA 素材",
        offerDetailsPlaceholder: "填写真实价格、折扣、套装、免邮、保修、赠品或行动提示。未填写时不会虚构优惠。",
        templateAutoInstruction: "为每张分镜从下面 25 个模板中匹配最合适的 templateId，并从该模板列出的 variants 中选择 variantId；不同分镜可以使用不同模板。目录：\n{{catalog}}",
        templateManualInstruction: "所有分镜固定使用模板 {{templateId}}（{{templateName}}），变体固定或优先使用：{{variant}}。每项仍须原样返回这个 templateId 和对应 variantId。",
        styleLock: "品牌风格锁（可选）",
        styleLockPlaceholder: "例如：品牌色 #E53935；暖白背景；柔和右侧光；圆角线性图标；留白充足。整套分镜会严格复用。",
        proofPoints: "可信证据（可选）",
        proofPointsPlaceholder: "填写可被画面使用的真实尺寸、材质、检测、保修、评价或对比数据。未填写时不会生成认证与量化承诺。",
        autoStyleLock: "根据商品参考图提取克制的配色与材质语言",
        noProofPoints: "未提供可信证据，不得生成认证、测试结果、评分、保修、尺寸或量化效果",
        sectionCount: "分镜张数",
        ratio: "单图比例",
        changeRatioTitle: "切换单图比例",
        changeRatioConfirm: "切换比例会清空当前分镜和长图，请确认是否继续。",
        imageModel: "图片模型",
        planningModel: "分镜规划模型",
        copyOverlay: "独立文案层",
        platformPreset: "平台导出规格",
        sliceHeight: "分段高度",
        presets: {
            taobao: "淘宝 / 天猫 · {{width}}px",
            jd: "京东 · {{width}}px",
            pdd: "拼多多 · {{width}}px",
            douyin: "抖音电商 · {{width}}px",
            hd: "高清通用 · {{width}}px",
        },
        generate: "生成商品详情页",
        generating: "生成中 · {{time}}",
        phases: {
            planning: "正在规划分镜 · {{time}}",
            generating: "正在生成分图 · {{time}}",
            editing: "正在修改分图 · {{time}}",
            composing: "正在合成长图",
            exporting: "正在导出分段",
        },
        ...
        moveUp: "向前移动",
        moveDown: "向后移动",
        deleteSectionTitle: "删除分镜",
        deleteSectionConfirm: "确定删除「{{title}}」并重新合成长图吗？",
        previousVersion: "上一个版本",
        nextVersion: "下一个版本",
        editSection: "修改此图",
        editSectionTitle: "修改分图并重新生成",
        regenerateSection: "重新生成并合并",
        editPromptPlaceholder: "描述希望保留和修改的内容，例如：保留商品与构图，将背景改为户外露营场景，光线更明亮。",
        editPromptRequired: "请输入修改要求",
        localizing: "正在后台保存到本地，不影响继续操作",
        localizeRetry: "本地保存失败，点击重试",
        editCopy: "编辑独立文案",
        editCopyTitle: "编辑分镜文案",
        overlayTitle: "主标题",
        overlayBody: "补充说明",
        longImage: "详情页长图",
        longImageCount: "已合入 {{count}} 张分镜",
        longImageEmpty: "分镜生成后会自动按顺序合成长图",
        exportSlices: "分段打包下载",
        slicedPackage: "详情页分段",
        exportedSlices: "已导出 {{count}} 张分段图片",
        exportFailed: "分段导出失败，请重新合成长图后再试",
        emptyTitle: "等待生成商品详情页",
        emptyDescription: "上传商品主图并填写真实卖点，系统会先规划分镜，再生成保持商品一致的成套竖图。",
        waiting: "等待生成",
        referenceRequired: "请先上传商品主图",
        referenceReadFailed: "商品主图读取失败，请重新上传",
        productInfoRequired: "请填写商品信息与核心卖点",
        planInvalid: "文本模型返回的分镜格式不正确，请重试",
        planFallback: "分镜规划服务暂时不可用，已切换到本地标准分镜继续生成",
        composeFailed: "长图合成失败，部分远程图片可能不允许跨域读取",
        generationFailed: "商品详情页生成失败",
        generatedSummary: "详情页生成完成：成功 {{success}}/{{total}} 张",
        assetTag: "电商详情",
        fallbackStages: {
            hero: "品牌首屏",
            benefit: "核心卖点",
        ...
        fallbackPrompt: "为「{{packageType}}」制作主题为「{{focus}}」的分镜，购买动机为「{{conversionDriver}}」。画面以商品和一个清晰信息目标为中心，为独立文案层预留明确安全区。",
        domesticPlanInstruction: "你是资深国内电商视觉策划。结合商品参考图和用户提供的真实信息，为 {{domesticPlatform}} 规划 {{count}} 张 {{ratio}} 分镜。图包目标：{{packageType}}；序列原则：{{packageHint}}；购买动机：{{conversionDriver}}；转化原则：{{conversionHint}}；视觉方案：{{visualPreset}}；品牌规则：{{styleNotes}}；可信证据：{{proofPoints}}。不要应用 Amazon、海外市场、外币、海外计量单位或外语文案规则。模板规则：{{templateInstruction}}。可用分镜角色如下，每张必须选择一个 role：\n{{roleLibrary}}\n必须只输出一个 JSON 数组，恰好 {{count}} 项，每项格式为 {\"title\":\"简短中文内部分镜名\",\"role\":\"角色代码\",\"templateId\":\"场景模板代码\",\"variantId\":\"变体代码，没有则为空字符串\",\"headline\":\"适合国内电商的简体中文独立文案标题\",\"body\":\"适合国内电商的简体中文独立文案正文，可为空\",\"prompt\":\"该分镜独有的构图、场景、光线、镜头和信息布局要求\"}。所有 headline/body 必须自然、简短并适合移动端。每张承担不同转化职责，镜头与景别有节奏变化，商品外观、Logo、颜色、材质和比例保持一致。只使用用户提供的真实商品信息和可信证据，不得虚构参数、认证、评价、价格、折扣、物流、保修、效果或竞品。prompt 不要重复场景模板、Campaign Style Lock、商品信息全文或图内文字要求，应用会统一补齐；画面默认不直接生成文字，只为独立文案层留白。不要输出 Markdown、解释或 JSON 之外的文字。",
        planInstruction: "你是资深跨境电商视觉策划。结合商品参考图和用户提供的真实信息，规划 {{count}} 张 {{ratio}} 分镜。图包目标：{{packageType}}；序列原则：{{packageHint}}；购买动机：{{conversionDriver}}；转化原则：{{conversionHint}}；视觉方案：{{visualPreset}}；品牌规则：{{styleNotes}}；可信证据：{{proofPoints}}。跨境市场锁：{{marketBrief}}。模板规则：{{templateInstruction}}。可用分镜角色如下，每张必须选择一个 role：\n{{roleLibrary}}\n必须只输出一个 JSON 数组，恰好 {{count}} 项，每项格式为 {\"title\":\"简短中文内部分镜名\",\"role\":\"角色代码\",\"templateId\":\"场景模板代码\",\"variantId\":\"变体代码，没有则为空字符串\",\"headline\":\"严格按 COPY LOCALE 规则生成的独立文案标题\",\"body\":\"严格按 COPY LOCALE 规则生成的独立文案正文，可为空\",\"prompt\":\"该分镜独有的构图、场景、光线、镜头和信息布局要求\"}。所有 headline/body 必须是目标市场自然表达，不做逐字翻译，并保持移动端短文案。每张承担不同转化职责，镜头与景别有节奏变化，商品外观、Logo、颜色、材质和比例保持一致。只使用可信证据与 Offer，不得虚构参数、认证、评价、价格、折扣、物流、保修、效果或竞品。prompt 不要重复场景模板、Campaign Style Lock、CROSS-BORDER MARKET LOCK、商品信息全文或图内文字要求，应用会统一补齐；画面默认不直接生成文字，只为独立文案层留白。不要输出 Markdown、解释或 JSON 之外的文字。",
    },
    videoWorkbench: {
        title: "视频创作台",
    ...
    canvas: {
        ...
        export: { defaultProjectName: "未来画布", defaultNodesName: "画布元素", item: "元素" },
        createMenu: {
    ...
    home: {
        promptError: "获取提示词失败",
        description: "在 <canvas>未来画布</canvas> 中生成、连接和重组 <content>图片、文字与图形</content>，让创作从单次生成变成连续推演。",
        start: "开始使用",
        openCanvas: "打开画布",
    ...
    config: {
        ...
        localStorage: {
            ...
            description: "查看未来画布在浏览器中保存的数据量，并按对象仓库统计内容体积。",
