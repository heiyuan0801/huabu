...
const IMAGE_KEYWORDS = ["seedream", "nano-banana", "gpt-image", "image", "dall-e", "dalle", "imagen", "flux", "sdxl", "stable-diffusion", "midjourney"];
            ...
            merge: (persisted, current) => {
                ...
                return {
                    ...
                    config: {
                        ...
                        grokVideoMode: config.grokVideoMode || "generate",
